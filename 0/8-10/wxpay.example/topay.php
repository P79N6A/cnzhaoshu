...
<body>
    ...
    <script type="text/javascript">
		...
		function result(serial_number){
			$.getJSON('/com/update_orderstate.php',{serial_number:serial_number,bid_userid:bid_userid,userid:user.userid,money:money,tree_order_id:tree_order_id,way:way},function(json){
				history.go(-2);
			})
		}
