...
$sql = 'update bid_order set state=7 where userid=? and id=?';
$result = $db->prepare_exec( $sql, array($bid_userid,$tree_order_id) );

$sql = 'update orders set order_switch=2,order_switch_time=? ,order_switch_remark=? where tree_order_id=? and bid_userid=?';
