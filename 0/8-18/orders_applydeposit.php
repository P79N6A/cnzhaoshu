...
ignore_user_abort();
$oldtime=60;
$turl="http://cnzhaoshu.com/wxpay/example/orders_applydeposit.php";
...
if(!$run) die;
    ...
    $sql = 'select id,serial_number,bid_userid,tender_userid,tree_order_id,deposit from orders where deposit_switch=1 and order_switch=5 and order_switch_time < \''.$time.'\'';
