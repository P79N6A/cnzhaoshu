    ...
    <script id="dot_bid_order" type="text/x-dot-template">
        {{ for(var i in it) { }}
            <div class="{{=checkclass(it[i].state)}}" data-userid="{{=it[i].userid}}" data-state="{{=it[i].state}}" data-orderid="{{=it[i].orderid}}" data-serial="{{=it[i].serial_number}}" data-id="{{=it[i].id}}">
                ...
                {{=((it[i].state == 2) && (it[i].deposit_refund_time) && (it[i].order_switch == 1) ) ? '<div class="button_delivery">发货</div>' : ''}}
                {{=(it[i].state == 3) ? '<div class="button_over">运输中</div>' : ''}}
            </div>
        {{ } }}
    </script>
        ...
        {{ for(var i in it) { }}
            <div class="buy_onedatainfo" treeuserid="{{=it[i].treeuserid}}" order_oneid="{{=it[i].id}}">
                ...
                <div>
                    ...
                    {{=((it[i].state == 2) && (it[i].delivery_time) && (it[i].order_switch == 1) ) ? '<div class="button_receipt">确认收货</div>' : ''}}
                    {{=((it[i].state == 2) && (it[i].delivery_time) && (it[i].order_switch == 1) ) ? '<div class="button_notreceipt">拒收货</div>' : ''}}
