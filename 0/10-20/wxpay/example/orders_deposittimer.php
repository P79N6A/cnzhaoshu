...
$run = include '../../com/ordersdeposit_timer1.php';
...
if(!$run) die;
	...
	$sql = 'select serial_number,tree_order_id,bid_userid,tender_userid,deposit from orders where deposit_switch=1 and (order_switch=1 or order_switch=4) and deposit_time < \''.$time.'\'';
