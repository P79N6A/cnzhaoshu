<?php 
	...
	$sql = 'select id,userid,name,unit,type,typename,count,trunk_diameter,ground_diameter,plant_height,crown,branch_number,bough_number,age,branch_length,bough_length,branch_point_height,pot_diameter,plant_height_cm,crown_cm,substrate,mark from tree_order where orderid=?';
