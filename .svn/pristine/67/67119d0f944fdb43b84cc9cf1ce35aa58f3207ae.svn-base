...
<body ontouchstart>
    ...
    <script id="dot_onedatabuy" type="text/x-dot-template">
        {{ for(var i in it) { }}
            <div class="buy_onedatainfo" treeuserid="{{=it[i].treeuserid}}" order_oneid="{{=it[i].id}}" price="{{=it[i].price}}" number="{{=it[i].number}}" state="{{=it[i].state}}">
                <div>
                    <div class="info">
                        <div><div class="onebuyleft" style="">订单编号：</div><div class="onebuyright">{{=it[i].serial_number}}</div></div>
                        <div><div class="onebuyleft" style="">商品名称：</div><div class="onebuyname">{{=it[i].name}}</div></div>
                        <div><div class="onebuyleft" style="">规&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</div><div class="onebuyright">{{=one_attribute(it[i])}}</div></div>
                        <div><div class="onebuyleft" style="">数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量：</div><div class="onebuyright">{{=it[i].number}}</div></div>
                    ...
                    <div><div class="onebuyleft" style="">供&nbsp;&nbsp;货&nbsp;&nbsp;商：</div><div class="onebuyright">{{=it[i].username}}<a href="tel:{{=it[i].userphone}}" class="info_phone">{{=it[i].userphone}}</a></div></div>
                    ...
                    <div><div class="onebuyleft" style="">订单时间：</div><div class="onebuyright">{{=it[i].orderstart_time}}</div></div>
                </div>
                <div>
        ...
        {{ for(var i in it) { }}
            <div class="sell_onedatainfo" userid="{{=it[i].userid}}" order_oneid="{{=it[i].id}}">
                <div>
                    ...
                    <div><div class="onebuyleft" style="">供&nbsp;&nbsp;货&nbsp;&nbsp;商：</div><div class="onebuyright">{{=it[i].username}}<a href="tel:{{=it[i].phone}}" class="info_phone">{{=it[i].phone}}</a></div></div>
                    <div class="{{=(it[i].order_switch_time) ? '' : 'hide'}}"><div class="onebuyleft" style="">退款理由：</div><div class="onebuyright">{{=(it[i].order_switch_remark) ? it[i].order_switch_remark : '无'}}</div></div>
                </div>
                <div>
                    <div class="button_detail">查看进程</div>
    ...
    <script type="text/html" id="tpl_managerbuy">
        ...
        <script type="text/javascript">
            ...
            $('#orderinfo').on('click','.button_paydown',function(){
                ...
                window.location = "./wxpay/example/onetree_pay.php?order_oneid="+order_oneid+"&userid="+user.userid+"&treeuserid="+treeuserid+"&money="+price*number*0.3+"&name="+name+"&way=1";
            })
            ...
            $('#orderinfo').on('click','.button_payfull',function(){
                ...
                if(state == 2){
                    window.location = "./wxpay/example/onetree_pay.php?order_oneid="+order_oneid+"&userid="+user.userid+"&treeuserid="+treeuserid+"&money="+price*number*0.7+"&name="+name+"&way=2";
                }else{
                    window.location = "./wxpay/example/onetree_pay.php?order_oneid="+order_oneid+"&userid="+user.userid+"&treeuserid="+treeuserid+"&money="+price*number+"&name="+name+"&way=2";
                }
            })
