...
export const routeEqual = (route1, route2) => {
  ...
  return (route1.name === route2.name) /*&& objEqual(params1, params2) && objEqual(query1, query2)*//*解决选中问题后续触发问题不清楚*/
}
 ...
 */
export const getRemoveagsNav = (navList,name) => {
