        ...
        <div class="historybidorder">
            {{ for(var i in it) { }}
                <div class="historybidorder_one">
                    ...
                    <div class="historybidorder_one_price">{{=it[i].price}}元/株</div>
                </div>
            {{ } }}
        </div>
    </script>
    ...
    <script type="text/html" id="tpl_tender">
        ...
        <script type="text/javascript">
            ...
            $('.getphoto').click(function(){
                var orderid = $('.getphoto').attr('orderid');
                $.getJSON('/com/getqrcodeimage.php',{orderid:orderid},function(result){
                })
            })
            ...
            $('#order_time_button').click(function(){
                ...
                $.getJSON('/com/deal_tenderingorder.php',{orderid:orderid,time:time},function(result){
                    $('#alerttime').hide();
