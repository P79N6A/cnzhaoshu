...
ignore_user_abort();
$oldtime=60;
$turl="http://cnzhaoshu.com/wxpay/example/order_one_fulltimer.php";

$run = include '../../com/order_onefull_timer1.php';
...
if(!$run) die;
	...
	$sql = 'select serial_number,treeuserid,userid,fullamount from order_one where state=3 and order_switch=1 and receipt_time < \''.$time.'\'';
