...
<body ontouchstart>
    ...
    <script type="text/html" id="tpl_tender">
        ...
        <script type="text/javascript">
            $('.bigimages').css('width',$(window).width());                    
            ...
            $('.getphoto').click(function(){
                ...
                $('#bigimages').html('');
                $('<img>').addClass('bigimage').attr('src','./tenderimage/'+qrcode+'.jpg?t='+ new Date().getTime()).appendTo('#bigimages');
                $('.bigimages').show();
            })
            ...
            $('#order_time_button').click(function(){
                ...
                $.getJSON('/com/deal_changeordertime.php',{orderid:orderid,time:time},function(result){
                    ...
                    if(result){
                        $('#bigimages').html('');
                        $('<img>').addClass('bigimage').attr('src','./tenderimage/'+result+'.jpg?t='+ new Date().getTime()).appendTo('#bigimages');
                        $('.bigimages').show();
                    }
                })
            })
    ...
    <script type="text/html" id="tpl_current_order">
        ...
        <script type="text/javascript">
            ...
            $('#order_name_button').click(function(){
                ...
                var ordername = $('#order_name').val();
                if(ordername){
                    var detailed_address = $('#tree_arrive_address').val() ? $('#tree_arrive_address').val() : '无';
