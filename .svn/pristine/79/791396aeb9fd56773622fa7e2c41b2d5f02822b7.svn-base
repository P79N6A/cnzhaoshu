                ...
                if(agreen){
                    ...
                    if(topay){
                        ...
                        $.getJSON('/com/index_createorder.php',{data:JSON.stringify(data)},function(result){
                            if(result){
                                window.location = "./wxpay/example/onetree_pay.php?order_oneid="+result+"&userid="+user.userid+"&treeuserid="+allinfo.userid+"&money="+allinfo.price*data.number*0.3+"&name="+allinfo.name+"&way=1";
                            }
                        })                
                    }
                }else{
            ...
            if($('#number').val() && $('#address').val()){
                ...
                if(agreen){
                    ...
                    if(topay){
                        ...
                        $.getJSON('/com/index_createorder.php',{data:JSON.stringify(data)},function(result){
                            if(result){
                                window.location = "./onetreepay.php?order_oneid="+result+"&userid="+user.userid+"&treeuserid="+allinfo.userid+"&name="+allinfo.name+"&way=2&money="+allinfo.price*data.number;
                                window.location = "./wxpay/example/onetree_pay.php?order_oneid="+result+"&userid="+user.userid+"&treeuserid="+allinfo.userid+"&money="+allinfo.price*data.number+"&name="+allinfo.name+"&way=2";
                            }
                        })                 
                    }
                }else{
