                ...
                if(agreen){
                    ...
                    if(topay){
                        ...
                        $.getJSON('/com/index_createorder.php',{data:JSON.stringify(data)},function(result){
                            if(result){
                                window.location = "./wxpay/example/onetree_pay.php?order_oneid="+result+"&userid="+user.userid+"&treeuserid="+allinfo.userid+"&money="+allinfo.price*data.number*0.3+"&name="+name+"&way=1";
                            }
                        })                
                    }
                }else{
                    ...
                    if(topay){
                        ...
                        $.getJSON('/com/index_createorder.php',{data:JSON.stringify(data)},function(result){
                            if(result){
                                ...
                                window.location = "./wxpay/example/onetree_pay.php?order_oneid="+result+"&userid="+user.userid+"&treeuserid="+allinfo.userid+"&money="+allinfo.price*data.number+"&name="+name+"&way=2";
                            }
                        })                 
                    }
                }else{
