var TouchSlide = function (a) {
    ...
    "leftLoop" == i && (P += 2, m.appendChild(m.children[0].cloneNode(!0)), m.insertBefore(m.children[n - 1].cloneNode(!0), m.children[0])), N = e(m, '<div class="tempWrap" style="float:left; width:100%; overflow:hidden; position:relative;"></div>'), m.style.cssText = "width:" + P * M + "px;" + "position:relative; overflow:hidden;padding:0;margin:0;";
    ...
    var W = function (a, b, c) {
        ...
        if (!document.getElementById(b.slideCell.replace("#", ""))) {
