        ...
        <div class="ycList">
            ...
            <div class="type" v-for="item in superviseInfo" :key="item.id">
                ...
                <div :class="item.content?'content content2':'content'">
                    ...
                    <div v-show="item.content" class="yctext">
                        <div>平台处理</div>
...
<script>
    import {getTreeSuperviseInfo,getTwoCodeInfo} from "../../api/supervise"
        ...
        methods: {
            ...
            getTreeInfo() {
                ...
                getTreeSuperviseInfo(data).then(res => {
                   ...
                   this.lastState = lastState.splice(this.superviseInfo.length)
                })
