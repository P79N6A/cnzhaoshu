...
?>
    ...
    <style type="text/css">
        ...
        .order_time_button_reset,#order_time_button{
            margin: 3% 0 3% 22%;
        }
        ...
        .phone_button_reset,.order_name_button_reset,#reset{
            -moz-user-select: none;
        ...
        #phone_button,#order_name_button,#add{
            -moz-user-select: none;
            border: 1px solid transparent;
            border-radius: 4px;
            cursor: pointer;
        ...
        .button_paydown,.button_payfull,.button_applyrefund,.button_detail,.button_evaluate,.button_receipt,.button_refunding,.button_notreceipt,.button_handing,.button_over,.button_retreat,.button_notretreat,.button_applydeposit,.button_agreepay,.button_disagreepay,.button_delivery,.disagree,.agree,.bid_content_evaluate,.bid_detail,.button_delete{
            float: right;
            display: inline-block;
            padding: .15em .4em;
            min-width: 8px;
...
<body ontouchstart>
    ...
    <script id="dot_bid_order" type="text/x-dot-template">
        {{ for(var i in it) { }}
            <div class="{{=checkclass(it[i].state)}}  {{=background(it[i].serial_number)}}" data-userid="{{=it[i].userid}}" data-state="{{=it[i].state}}" data-orderid="{{=it[i].orderid}}" data-serial="{{=it[i].serial_number}}" data-id="{{=it[i].id}}">
                <div class="bid_content_row0 {{=(it[i].state < 2) ? 'hide' : ''}}">
                ...
                {{=(it[i].state == 18) ? '<div class="button_delete">删除</div>' : ''}}
            </div>
        {{ } }}
    </script>
    ...
    <script id="dot_onedatabuy" type="text/x-dot-template">
        {{ for(var i in it) { }}
            <div class="buy_onedatainfo {{=witchbackground(it[i].serial_number)}}" treeuserid="{{=it[i].treeuserid}}" order_oneid="{{=it[i].id}}" price="{{=it[i].price}}" number="{{=it[i].number}}" state="{{=it[i].state}}">
                    <div class="info">
                        <div class="onebuyleft" style="">订单编号：</div><div class="onebuyright">{{=it[i].serial_number}}</div>
                        <div class="onebuyleft" style="">商品名称：</div><div class="onebuyname">{{=it[i].name}}</div>
                        <div class="onebuyleft" style="">规&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</div><div class="onebuyright">{{=one_attribute(it[i])}}</div>
                        <div class="onebuyleft" style="">数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量：</div><div class="onebuyright">{{=it[i].number}}</div>
                        <div class="{{=(it[i].address) ? '' : 'hide'}}"><div class="onebuyleft" style="">用&nbsp;&nbsp;苗&nbsp;&nbsp;地：</div><div class="onebuyright">{{=it[i].address}}</div></div>
                        <div class="{{=(it[i].mark) ? '' : 'hide'}}"><div class="onebuyleft" style="">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</div><div class="onebuyright">{{=it[i].mark}}</div></div>
                    </div>
                    <div class="onebuyleft" style="">供&nbsp;&nbsp;货&nbsp;&nbsp;商：</div><div class="onebuyright">{{=it[i].username}}<a href="tel:{{=it[i].userphone}}" class="info_phone">{{=it[i].userphone}}</a></div>
                    <div class="{{=(it[i].order_switch_time) ? '' : 'hide'}}"><div class="onebuyleft" style="">退款理由：</div><div class="onebuyright">{{=(it[i].order_switch_remark) ? it[i].order_switch_remark : '无'}}</div></div>
                    <div class="onebuyleft" style="">订单时间：</div><div class="onebuyright">{{=it[i].orderstart_time}}</div>
                    ...
                    {{=(it[i].state == 10) ? '<div class="button_delete">删除</div>' : ''}}
            </div>
        {{ } }}
    </script>
    <script id="dot_onedatasell" type="text/x-dot-template">
        {{ for(var i in it) { }}
            <div class="sell_onedatainfo  {{=witchbackground(it[i].serial_number)}}" userid="{{=it[i].userid}}" order_oneid="{{=it[i].id}}">
                <div class="info">
                    <div class="onebuyleft" style="">订单编号：</div><div class="onebuyright">{{=it[i].serial_number}}</div>
                    <div class="onebuyleft" style="">商品名称：</div><div class="onebuyname">{{=it[i].name}}</div>
                    <div class="onebuyleft" style="">规&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</div><div class="onebuyright">{{=one_attribute(it[i])}}</div>
                ...
                <div class="onebuyleft" style="">采&nbsp;&nbsp;购&nbsp;&nbsp;商：</div><div class="onebuyright">{{=it[i].username}}<a href="tel:{{=it[i].phone}}" class="info_phone">{{=it[i].phone}}</a></div>
                <div class="{{=(it[i].order_switch_time) ? '' : 'hide'}}"><div class="onebuyleft" style="">退款理由：</div><div class="onebuyright">{{=(it[i].order_switch_remark) ? it[i].order_switch_remark : '无'}}</div></div>
                <div class="button_detail">查看进程</div>
    ...
    <script type="text/javascript">
        ...
        function onerrorHeadimg() {
            ...
            img.src = 'https://cnzhaoshu.com/headimg/96/1.jpg';
        }
        ...
        $(function(){
            ...
            $('#container').on('click','.js_item', function(){
                var id = $(this).data('id');
                window.pageManager.go(id);
            });
            $('#container').on('click','.js_category', function(){
                var $this = $(this),
    ...
    <script type="text/html" id="tpl_home">
        <div class="page">
            <div class="userbuy weui-cell_access js_item" data-id="buy">我买树</div>
            <div class="usersell weui-cell_access js_item" data-id="sell">我卖树</div>
        </div>
        <script type="text/javascript">
            var sum;
            $('.userbuy').css('line-height',(windowheight/2)+'px');
            $('.usersell').css('line-height',(windowheight/2)+'px');

            function getTitle () {
                return '找树网交易中心';
            }
            function getImageUrl(){
                return 'https://cnzhaoshu.com/img/hall.jpg';
            }

            function getLink(){
                return 'https://cnzhaoshu.com/yusuanphone.php';
            } 
              
            function getDescription () {
                return '找树宝交易量'+(sum/100)+'元';                     
            }
            ...
            function loadWechatJSSDK() {
                ...
                $.getJSON('/com/search_sum_recharge_bill.php', function (result) {
    ...
    <script type="text/html" id="tpl_buy">
        <div class="page" style="background-color: #eee">
            <div class="weui-cell_access js_item titlename1" data-id="current_order">制作招标二维码</div>
            <div class="weui-cell_access js_item titlename" data-id="tender">正在进行的招标</div>
            <div class="weui-cell_access js_item titlename" data-id="tenderhistory">招标历史信息</div>
            <div class="weui-cell_access js_item titlename" data-id="managerbuy">找树宝</div>
            <div class="weui-cell_access js_item titlename" data-id="supplier">我的供货商</div>
            <div class="weui-cell_access js_item titlename" data-id="mywallet">我的钱包</div>
            <div class="homeindex" onclick="window.pageManager.go('home')">
            </div>
        </div>
    </script>
    <script type="text/html" id="tpl_sell">
        <div class="page" style="background-color: #eee">
            <div class="weui-cell_access js_item titlename1" data-id="bidhistory">我的投标信息</div>
            <div class="weui-cell_access js_item titlename" data-id="managersell">找树宝</div>
            <div class="weui-cell_access js_item titlename" data-id="customer">我的客户</div>
            <div class="homeindex" onclick="window.pageManager.go('home')">
            </div>
        </div>
    </script>
    <script type="text/html" id="tpl_current_order">
        <div class="page writeing">
            <div class="page__bd" id="current_orders">
                ...
                <div id="alertordername">
                    <div id="alertinfo">
                        ...
                        <button type="button" class="order_name_button_reset">取消</button>
            ...
            <div class="homeindex" onclick="window.pageManager.go('buy')">
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function showattributeindex() {
                ...
                window.location = 'https://cnzhaoshu.com/m.php?where={'+indexdata+'}';
                snake = -1; 
            }
            ...
            function getLink(){
                return 'https://cnzhaoshu.com/yusuanphone.php#current_order';
            } 
    ...
    <script type="text/html" id="tpl_managerbuy">
        ...
        <script type="text/javascript">
            ...
            var starnumber;
            var evaluatebutton;
            var getdata = window.location.href.split('?');
            if(getdata[1]){
                var getdata = getdata[1].split('#');
                getdata = getdata[0].split('&');
                var way = getdata[0].split('=');
                var mid = getdata[1].split('=');
                if(way[0] == 'mbway'){
                    way = way[1];
                }
                if(mid[0] == 'mbid'){
            ...
            $('#orderinfo').css('height',(windowheight-53)+'px');

            function witchbackground(one){
                if((one == mid) && one){
                    return 'colorback';
                }
            }
            ...
            $('#orderinfo').on('click','.onebuyname',function(){
                window.location = 'https://cnzhaoshu.com';
            })
            ...
            $('#orderinfo').on('click','.button_paydown',function(){
                ...
                var price = that.parents('.buy_onedatainfo').attr('price');
                var number = that.parents('.buy_onedatainfo').attr('number');
                var order_oneid = that.parents('.buy_onedatainfo').attr('order_oneid');
                var name = that.parents('.buy_onedatainfo').find('.onebuyname').html();
                var money = Math.ceil(100*price*number*0.3*1.008);

                window.location = "./wxpay/example/onetree_pay.php?order_oneid="+order_oneid+"&userid="+user.userid+"&treeuserid="+treeuserid+"&money="+money/100+"&name="+name+"&way=1";
            })
            ...
            $('#orderinfo').on('click','.button_payfull',function(){
                ...
                var price = that.parents('.buy_onedatainfo').attr('price');
                var number = that.parents('.buy_onedatainfo').attr('number');
                var state = that.parents('.buy_onedatainfo').attr('state');

                if(state == 2){
                    var money = Math.ceil(100*price*number*0.7*1.008);
                    window.location = "./wxpay/example/onetree_pay.php?order_oneid="+order_oneid+"&userid="+user.userid+"&treeuserid="+treeuserid+"&money="+money/100+"&name="+name+"&way=2";
                }else{
                    var money = Math.ceil(100*price*number*1.008);
                    window.location = "./wxpay/example/onetree_pay.php?order_oneid="+order_oneid+"&userid="+user.userid+"&treeuserid="+treeuserid+"&money="+money/100+"&name="+name+"&way=2";
                }
            })
            ...
            $('#orderinfo').on('click','.button_agreepay',function(){
                ...
                $.get('/wxpay/example/agree_order_onedeposite.php', {userid:user.userid,id:order_oneid}, function(result) {
                    if(result){
                        if(result == -1){
                            alert('网站账户资金不足，请联系王众：13810525928');
                            return;
                        }
                        buy_unfinsheddata = [];
                        buy_finsheddata = [];
            ...
            $('#orderinfo').on('click','.button_delete',function(){
                var edit = confirm('您确定删除本条记录？');
                if(!edit) return;
                var button_delete = $(this);
                var order_oneid = button_delete.parents('.buy_onedatainfo').attr('order_oneid');
                $.get('/com/make_order_hideen.php',{serial:order_oneid,witch:'order_one',who:2},function(result){ 
                    if(result){
                        button_delete.parents('.buy_onedatainfo').remove();
                    }
                })
            });
            ...
            $('.uploads').click(function(){
                ...
                if($('.uploads').hasClass('ar')){
                    $.get('/com/order_one_stop.php',{id: order_oneid,remark:remark},function(result){
                        if(result){
            ...
            if(way == 1){
                $('#orderinfo').html('');
                $('.checked').removeClass('checked');
                $('.headtitle1 .finshed').addClass('checked');
                if(buy_finsheddata.length){
                    $('#orderinfo').html(dot_onedatabuy(buy_finsheddata));
                }else{
                    loadfinshed();
                ...
                $('#orderinfo').html('');
                $('.checked').removeClass('checked');
                $('.headtitle1 .unfinshed').addClass('checked');
                if(buy_unfinsheddata.length){
                    $('#orderinfo').html(dot_onedatabuy(buy_unfinsheddata));
                }else{
                    loadunfinshed();
    ...
    <script type="text/html" id="tpl_bidhistory">
        <div class="page">
            <div class="page__bd" style="height: 100%;">
                <div class="weui-tab">
                    <div class="headtitle1">
                        <div class="homeindex" onclick="window.pageManager.go('sell')">
                        </div>
        ...
        <script type="text/javascript">            
            ...
            if(way == 1){
                $('.overbid').addClass('checked').siblings('.checked').removeClass('checked');
                $('#bidhistory_info').html('');
                if(overbidinfo.length){
                    $('#bidhistory_info').append(dot_bid_order(overbidinfo));
                }else{
                    loadoverbidorder();
                }
            }else{
                $('.successbid').addClass('checked').siblings('.checked').removeClass('checked');
                $('#bidhistory_info').html('');
            ...
            $('#bidhistory_info').on('click','.agree',function(e){
                ...
                $.getJSON('/wxpay/example/orders_agreerefund.php',{serial:serial},function(json){ 
                    if(json){
                        if(result == -1){
                            alert('网站余额不足，请联系王众：13810525928');
                            return;
                        }   
                        var newsucc = [];
                        for (var i = 0; i < successbidinfo.length; i++) {
            ...
            $('#bidhistory_info').on('click','.button_delete',function(e){
                var edit = confirm('您确定删除本条记录？');
                if(!edit) return;
                var button_delete = $(this);
                var serial = button_delete.parents('.bid_contents').data('serial');
                $.get('/com/make_order_hideen.php',{serial:serial,witch:'orders',who:1},function(result){ 
                    if(result){
                        button_delete.parents('.bid_contents').remove();
                    }
                })
            });
    ...
    <script type="text/html" id="tpl_managersell">
        ...
        <script type="text/javascript">
            ...
            $('#sellorderinfo').css('height',(windowheight-55)+'px');
            function loadunfinshed(){
                if (sell_isloadunfinshed) return;
                sell_isloadunfinshed = true;
                var limit = $('#sellorderinfo .sell_onedatainfo').length + ',' + 10;
                $.getJSON('/com/search_order_oneunfinshedsell.php', {userid:user.userid,limit:limit}, function(json) {
                    if(json){
                        ...
                        for (var i = 0; i < json.length; i++) {
                            ...
                            var news = [];
                            news[0] = json[i];
                            $('#sellorderinfo').append(dot_onedatasell(news));
                        }
                    }else{
            ...
            $('#sellorderinfo').on('click','.onebuyname',function(){
                window.location = 'https://cnzhaoshu.com';
            })
            ...
            $('.unfinshed').click(function(){
                ...
                $('.checked').removeClass('checked');
                $(this).addClass('checked');
                if(sell_unfinsheddata.length){
                    $('#sellorderinfo').html(dot_onedatasell(sell_unfinsheddata));
                }else{
                    loadunfinshed();
                }                
            })
            ...
            $('.finshed').click(function(){
                ...
                $('.checked').removeClass('checked');
                $(this).addClass('checked');
                if(sell_finsheddata.length){
                    $('#sellorderinfo').html(dot_onedatasell(sell_finsheddata));
                }else{
                    loadfinshed();
                }  
            })

            $('#sellorderinfo').on('click','.button_detail',function(){
                $('.box').remove();
            ...
            $('#sellorderinfo').on('click','.button_applydeposit',function(){
                var order_oneid = $(this).parents('.sell_onedatainfo').attr('order_oneid');
                var sure = confirm('您确定要申请定金！');
                if(!sure) return;
            ...
            $('#sellorderinfo').on('click','.button_retreat',function(){
                var that = $(this);
            ...
            $('#sellorderinfo').on('click','.button_notretreat',function(){
            ...
            $('#sellorderinfo').on('click','.button_delivery',function(){
            ...
            $('#sellorderinfo').on('click','.button_delete',function(){
                var edit = confirm('您确定删除本条记录？');
                if(!edit) return;
                var button_delete = $(this);
                var order_oneid = button_delete.parents('.sell_onedatainfo').attr('order_oneid');
                $.get('/com/make_order_hideen.php',{serial:order_oneid,witch:'order_one',who:1},function(result){ 
                    if(result){
                        button_delete.parents('.sell_onedatainfo').remove();
                    }
                })
            });

            $('#sellorderinfo').on('click','.button_evaluate',function(){
                evaluatebutton = $(this);
                $('.evaluate_content').show();
            })
